...
En esta sección, se mostrará la explicación del video y demostración de compilación en el programa: 
https://youtu.be/yzQXeavd6_Y
...
## Conclusion
En la práctica 5 se tuvo el primer contacto con el microcontrolador PIC 18 en todo el semestre. Para comenzar, la práctica fue relativamente sencilla, en donde se utilizó el lengaje de programación en C. Se tuvieron conocimientos previos en la clase, donde se utilizaron los conceptos de interruptores, inicialización de puertos, clocking interrupts y osciladores. Gracias a los conceptos mencionados, se pudo tener idea y comprender lo que el controlador está haciendo, y gracias al SFR del MPlab podemos ver de manera de texto que puertos están encendidos, cuales son el comportamiento de ellos (Gracias a la función LATx y PORTx). En la práctica, se tuvieron problemas como la falta del compilador, y lo usual en la creación del código con los errores de compilación, el cual, solo por falta de elementos y puntuación escenciales en el lenguaje de programación.
